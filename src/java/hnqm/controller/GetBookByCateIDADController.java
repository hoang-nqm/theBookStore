 ...
 * @author Minh Hoang
 */
@WebServlet(name = "GetBookByCateIDADController", urlPatterns = {"/GetBookByCateIDADController"})
public class GetBookByCateIDADController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<BookDTO> listBook = bookDAO.getBookByCateID(cateID);
            if (listBook != null) {
