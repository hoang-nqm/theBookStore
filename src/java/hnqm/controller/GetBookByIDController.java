 ...
 * @author Minh Hoang
 */
@WebServlet(name = "GetBookByIDController", urlPatterns = {"/GetBookByIDController"})
public class GetBookByIDController extends HttpServlet {

    private static final String SUCCESS = "viewUpdate.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!bookID.isEmpty()) {
                ...
                request.setAttribute("IMPORT", book.getImportDate());
